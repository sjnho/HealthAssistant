...
public class SjnApplication extends Application {
    ...
    private void initDatabase() {
        ...
        RealmQuery<HealthClassify> healthClassifyRealmQuery = realm.where(HealthClassify.class);
        if (healthClassifyRealmQuery.findAll().size() == 0) {
        ...
        RealmQuery<DrugClassify> drugClassifyRealmQuery = realm.where(DrugClassify.class);
        if (drugClassifyRealmQuery.findAll().size() == 0) {
